...
export class ProviderAvailabilityController {
  ...
  @ApiOperation({
    ...
    description:
      "Create availability slots for a healthcare provider. Supports recurring patterns and generates appointment slots automatically.",
  })
  @ApiResponse({
    status: 201,
  ...
  async createAvailability(
    ...
    const providerId = "688a08b87a695b7b955e5c84"; // This should be extracted from JWT
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve availability slots for a specific provider within a date range.",
  })
  @ApiParam({
    name: "provider_id",
  ...
  @ApiOperation({
    ...
    description:
      "Update a specific availability slot. Cannot update booked slots.",
  })
  @ApiParam({
    name: "slot_id",
  ...
  async updateAvailabilitySlot(
    ...
    return this.availabilityService.updateAvailabilitySlot(
      slotId,
      providerId,
      updateDto
    );
  ...
  @ApiOperation({
    ...
    description:
      "Delete a specific availability slot. Cannot delete booked slots.",
  })
  @ApiParam({
    name: "slot_id",
  ...
  async deleteAvailabilitySlot(
    ...
    return this.availabilityService.deleteAvailabilitySlot(
      slotId,
      providerId,
      query
    );
...
export class AvailabilitySearchController {
  ...
  @ApiOperation({
    ...
    description:
      "Search for available appointment slots based on various criteria like date, specialization, location, etc.",
  })
  @ApiQuery({
    name: "date",
